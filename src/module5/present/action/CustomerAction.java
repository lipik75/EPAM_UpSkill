...
public class CustomerAction {
    ...
    public void run() {
        ...
        presentDirector.setPresentMaker(new CandyPresentMaker());
        System.out.println(customer.getName() + ", who do you want to give a gift to?");
        customer.setPresent(presentDirector.makePresent());
    ...
    public static Wrap chooseWrap() {
        ...
        System.out.printf("1. Cardboard box (price: %.2f);\n2. Metal Box (price: %.2f);\n" +
                        "3. Foil Pouch (price: %.2f);\n4. Plastic Bag (price: %.2f).%n",
